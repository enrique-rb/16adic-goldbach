...
int main(int argc, char* argv[]) {
    std::cout << "Goldbach Conjecture Probabilistic Tester\n";
    std::cout << "---------------------------------------\n";
    ...
    if (argc > 1) k_min = std::stoi(argv[1]);
    if (argc > 2) k_max = std::stoi(argv[2]);
    if (argc > 3) save_primes = true;

    test_goldbach_probabilistic(k_min, k_max, save_primes);
